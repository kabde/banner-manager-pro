jQuery(function($) {
    ...
    function updateTypeFields() {
        if (currentType() === 'html') {
            $('#bmp-popup-image-fields').hide();
            $('#bmp-popup-html-fields').show();
        } else {
            $('#bmp-popup-image-fields').show();
            $('#bmp-popup-html-fields').hide();
        }
        updatePreview();
    }
    ...
    function htmlPreviewHtml() {
        ...
        if (!$.trim(html)) return '<div class="bmp-preview-empty">Aucun code HTML.</div>';
