...
class BMP_Meta {
	...
	public function render_box( $post ) {
		...
		private function get_position_options() {
			return [
				'header'     => __( 'En-tête', 'banner-manager-pro' ),
				'footer'     => __( 'Pied de page', 'banner-manager-pro' ),
				'sidebar1'   => __( 'Sidebar 1', 'banner-manager-pro' ),
				'sidebar2'   => __( 'Sidebar 2', 'banner-manager-pro' ),
				'in_article' => __( 'Dans les articles', 'banner-manager-pro' ),
				'in_listing' => __( 'Entre les articles', 'banner-manager-pro' ),
			];
		}
