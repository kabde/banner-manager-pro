...
class BMP_Popup_Meta {
	...
	public function render_box( $post ) {
		...
		$delay      = get_post_meta( $post->ID, '_bmp_popup_delay',      true ) ?: 2;
	...
	public function save( $post_id ) {
		...
		// Type
		$type = isset( $post_data['bmp_popup_type'] ) && in_array( $post_data['bmp_popup_type'], [ 'image', 'html' ], true ) ? $post_data['bmp_popup_type'] : 'image';
